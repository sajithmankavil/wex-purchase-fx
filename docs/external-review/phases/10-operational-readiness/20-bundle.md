...
| §1 F-05 | Rate-orientation drift WARN threshold | [`OrientationContractFixtureTest`](../../../../src/test/java/) + weekly canary spec in [`monitoring-alerting.md §4`](../../../operations/monitoring-alerting.md). | ⚠️ Weekly canary not yet scheduled (cron deferred to Phase 12). |
...
| §1 F-10..F-13 | DB pool / JVM / Tomcat — detection signals + auto-mitigation | Hikari pool metrics emitted; readiness probe in [`HealthController`](../../../../src/main/java/) checks `SELECT 1` + pool capacity; covered by `DbUnavailableReadinessIT`. | ✅ |
...
| §1 F-16 | PAN content guard | [`ContentGuard`](../../../../src/main/java/) + `PanPatternGuardTest`, `TrackDataGuardTest`, `EncodedPanGuardTest`. | ✅ |
| §1 F-17 | H2 cloud-sync warning | [`DataDirSyncPrefixWarningTest`](../../../../src/test/java/). | ✅ |
| §1 F-18 | Refuse-to-start on missing HMAC key | [`DescriptionHasher`](../../../../src/main/java/) bean constructor throws; `LoggingHashKeyStartupTest` (AC-032b). | ✅ |
